...
docker run -d -p 3000:3000 --name container_anderson_front -e REACT_APP_BACK_API_URL="http://localhost:8080" ghcr.io/projets-finaux-simplon-2024/front-anderson:main
